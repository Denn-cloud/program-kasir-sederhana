                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                <form action="simpan_menu.php" method="POST">
                                    ...
                                    $id = $_GET['id'];
                                    $a = "select * from menu where id_menu='$id'";
                                    $b = $koneksi->query($a);
                                    ...
                                    ?>
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" name="menu" value="<?= $d['nama_menu']; ?>">
                                                <input type="hidden" class="form-control" name="id" value="<?= $d['id_menu']; ?>">
